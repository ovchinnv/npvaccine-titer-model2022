...
errorbar(1:numel(agtest), iggexp1, 1*iggexpe1, iggexpe1, 'ko--', 'linewidth',1.5 );
l=legend([fns, {'experiment'}]); legend boxoff; set(l, 'fontsize',12)
set(gca, 'xtick',id);
set(gca, 'xticklabel',[]);
set(gca, 'tickdir','out');
xlim([0,numel(agtest)+1]);
%
set(gcf, 'paperpositionmode','auto');
print(gcf,'-depsc2','test-cov.eps');
%