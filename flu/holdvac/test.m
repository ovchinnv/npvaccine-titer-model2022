...
if (qholdvac)
 iholdvac_mat=zeros(nallags,numel(vacs));
 for i=iholdvacs(:)'
  iholdvac_mat(:,i)=1;
 end
 if (qtestholdvac)
  itestsample_mat=iholdvac_mat ;
 else
  itestsample_mat=itestsample_mat - iholdvac_mat ;
 end
end % qholdvac
...
oenmat=1./enmat;
%
clear iggexp1 iggexpe1 iggmod err
